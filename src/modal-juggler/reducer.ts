...
import { IModal, IModalJugglerState, ModalNames } from './interface';
...
export const hide                 = createAction(
  HIDE,
  (data: { name: ModalNames, meta?: string }) => data,
);
...
export const showAndHideSpecified = createAction(
  SHOW_AND_HIDE_SPECIFIED,
  (data: { name: ModalNames, specefied: ModalNames[] }) => data,
);
