...
export const SEARCH_DRILL_BY_ID_REQUEST = '[drills] SEARCH_DRILL_BY_ID_REQUEST';
export const searchDrillsByIdRequest    = (id: string) =>
  createAction(SEARCH_DRILL_BY_ID_REQUEST, { id });
export type searchDrillsByIdRequest = ReturnType<typeof searchDrillsByIdRequest>;

export const SEARCH_DRILL_BY_ID_SUCCESS = '[drills] SEARCH_DRILL_BY_ID_SUCCESS';
export const searchDrillsByIdSuccess    = (drills: NormDrills) =>
  createAction(SEARCH_DRILL_BY_ID_SUCCESS, { drills });

export const SEARCH_DRILL_BY_ID_FAIL = '[drills] SEARCH_DRILL_BY_ID_FAIL';
export const searchDrillsByIdFail    = (error: any) =>
  createAction(SEARCH_DRILL_BY_ID_FAIL, { error });
...
export type drillGenerationStatusError = ReturnType<typeof drillGenerationStatusError>;
