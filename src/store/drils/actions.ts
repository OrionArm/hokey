...
export const getDrillsCategoriesSuccess = (categories: DrillCategoriesGroupped) =>
...
export const DRILL_GENERATION_STATUS_ERROR = '[drills] DRILL_GENERATION_STATUS_ERROR';
